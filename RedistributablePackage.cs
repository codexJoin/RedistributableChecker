            ...
            try
            {
				switch (redistributableVersion)
				{
					...
					case RedistributablePackageVersion.VC2013x86:
						var parametersVc2013x86 = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Classes\Installer\Dependencies\{9dff3540-fc85-4ed5-ac84-9e3c7fd8bece}", false);
					...
					case RedistributablePackageVersion.VC2013x64:
						var parametersVc2013x64 = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Classes\Installer\Dependencies\{042d26ef-3dbe-4c25-95d3-4c1b11b235a7}", false);
